...
import '../guide_cards/guide_card_vertical.dart';


class SSortableGuides extends StatelessWidget {
  const SSortableGuides({
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        ///Guides
        Obx(() => SGridLayout(itemCount: controller.tourGuides.length, itemBuilder: (_, index) => SGuideCardVertical(guide: controller.tourGuides[index]))),
      ],
    );
  }
}
