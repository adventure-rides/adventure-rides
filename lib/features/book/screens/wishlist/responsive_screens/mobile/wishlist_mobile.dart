import 'package:adventure_rides/common/cars/cars_cards/mobile/mobile_wishlist_card_vertical.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../../../../../common/loaders/animation_loader.dart';
import '../../../../../../common/tour_guide/guide_cards/Mobile/mobile_guide_card_vertical.dart';
                ...
                return SGridLayout(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    if (index < cars.length) {
                      return MobileWishlistCardVertical(car: cars[index]);
                    } else {
                      return MobileGuideCardVertical(guide: guides[index - cars.length]);
                    }
                  },
                );
              },
